...
description: "Brainstorm is built entirely out of sandboxed apps over a shared object layer, and an app you build is a peer of the built-in ones. This is how you build one."
sidebar:
  label: Overview
  order: 0
---
