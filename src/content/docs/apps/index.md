---
title: Apps
description: "Brainstorm ships nothing but apps — focused, sandboxed tools that all work over the same shared objects. Twenty first-party apps ship with the public beta."
sidebar:
  label: Overview
  order: 0
---
...
An app can only touch what you allow. The first time an app needs a capability it asks, and you can review or revoke grants any time. See [Apps & permissions](/concepts/apps-and-permissions).
