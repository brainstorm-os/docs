---
title: Automations
description: "Reviewable workflows over your own apps, triggered by time, entity events, incoming email, webhooks or file changes — each declaring what it may touch."
sidebar:
  order: 12
---
