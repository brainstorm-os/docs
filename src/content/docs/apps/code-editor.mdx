...
<VideoEmbed
  id="fYHF2EKQXo4"
  title="Watch: an app built inside Brainstorm"
  caption="The Code editor in its real job — writing an app's files in the vault, then installing them as a live, sandboxed app."
/>
