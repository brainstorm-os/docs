...
description: "Brainstorm besteht vollständig aus Sandbox-Apps über einer gemeinsamen Objektschicht — eine App, die du baust, ist ein Peer der eingebauten. So baust du eine."
sidebar:
  label: Überblick
  order: 0
---
