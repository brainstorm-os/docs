...
Beim ersten Start fragt Brainstorm, wo dein Wissen leben soll.

1. Klicke auf **Vault erstellen**.
2. Wähle einen leeren Ordner auf deiner Festplatte.
3. Entscheide, wie du ihn schützt:
   - **System-Schlüsselbund** (empfohlen) — Brainstorm speichert den Schlüssel im Schlüsselbund deines Betriebssystems; der Vault entsperrt sich automatisch, wenn du dich anmeldest.
...
Brainstorm öffnet sich mit einem Dashboard. Alles, was du tust, geschieht innerhalb einer **App**.
...
- Fang an zu tippen, um eine Notiz zu erstellen.
- Nutze Rich Text — Überschriften, Listen, Kontrollkästchen, Code.
- Tippe `@`, um auf ein anderes Objekt in deinem Vault zu verlinken, oder `/` für ein Befehlsmenü.

Alles, was du schreibst, wird sofort und offline in deinem Vault auf der Festplatte gespeichert.

## 4. Dein Wissen verbinden

Brainstorms Wert kommt daraus, dass Objekte zueinander in Beziehung stehen:

- Öffne **Datenbank**, um eine strukturierte Tabelle zu erstellen — Aufgaben, Kontakte, Leseliste — mit typisierten Eigenschaften.
